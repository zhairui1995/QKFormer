...
\begin{itemize}
  ...
  \item We introduce support-aware and subspace-decoupled QK-LUT audits that
  make lookup misses explicit while testing whether compact sub-address
  subtables can preserve full-address reconstruction.
  ...
  checkpoint-stable accuracy, energy, latency, ImageNet, or full-wrapper
  claims.
\end{itemize}
