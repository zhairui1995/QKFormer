...
to the global mean. For downstream utility, we additionally use frozen-backbone
...
\begin{itemize}
  ...
  \item We use frozen-backbone residual LUT adapter probes to test whether
  calibrated Q/K-address prototypes transfer to downstream utility under
  strict global, token/channel, and shuffled-address controls.
