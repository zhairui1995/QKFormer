...
\end{equation}
Our conservative setting trains for two epochs over 128 training batches and
evaluates on the full validation split. We sweep $\alpha\in\{0.025,0.05,0.1\}$
and use $\alpha=0.025$ for low-disturbance checkpoint, stage, and dataset
controls.
