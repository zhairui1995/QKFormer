...
$\mathcal{S}=\{\mathrm{tc},\mathrm{q},\mathrm{k}\}$. This changes the memory
growth from a product over all address fields to a sum over low-dimensional
sub-address tables, while a shuffled-subspace control preserves the same
residual values but breaks their address alignment.
