...
token/channel, and shuffled-address controls. The registered gate fixes
$\alpha=0.025$, stage1, two training epochs, 128 calibration batches, and 128
adapter-training batches before evaluation. The backbone remains in evaluation
mode throughout adapter optimization so that BatchNorm statistics cannot drift.
