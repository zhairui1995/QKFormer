...
PYTHON_BIN="$(qk_lut_select_python)"
...
if not candidates:
    raise SystemExit("no completed CIFAR-100 checkpoint found")
...
echo "[qk-lut-c100-after-train] checkpoint=$QKFORMER_LUT_CKPT"
echo "[qk-lut-c100-after-train] gpu=$QKFORMER_LUT_GPU"
...
echo "[qk-lut-c100-after-train] done=$(date -Is)"
