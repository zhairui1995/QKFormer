...
Remote execution is pending. From the local machine, `192.168.70.60:22` times
out and ping to `192.168.70.60` has 100% packet loss. EasyConnect processes
are running, but `192.168.0/16` currently routes through the local Wi-Fi
gateway rather than the VPN interface. No smoke/full result has been generated.
