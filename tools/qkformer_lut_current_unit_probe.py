...
def run(args):
    ...
    if args.group_lut_only:
        method_specs = [
            ("qkformer_current_grouped_projection_lut_hard", "group_lut"),
        ]
    else:
        method_specs = [
            ("qkformer_current_static_aligned_lut_hard", "none"),
            ("qkformer_current_moment_matched_lut_hard", "moment"),
            ("qkformer_current_temporal_matched_lut_hard", "temporal"),
            ("qkformer_current_channel_matched_lut_hard", "channel"),
            ("qkformer_current_tcslu_moment_temporal_channel_backoff_hard", "tcslu"),
            ("qkformer_current_grouped_projection_lut_hard", "group_lut"),
        ]
...
def main() -> None:
    ...
    parser.add_argument("--family", choices=("cifar10", "cifar100"), default="cifar10")
